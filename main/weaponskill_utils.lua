...
function StarIliadWeaponSkill.AddAoetargetingClient(inst, aoetype, tags, range, extrafn)
    range = range or 8
...
function StarIliadWeaponSkill.AddAoetargetingServer(inst, spellfn, ondischarged, oncharged, extrafn)
...
GLOBAL.StarIliadWeaponSkill = StarIliadWeaponSkill
