...
local function MakePreparedFood(data)
    ...
    local has_inv_image = resolvefilepath_soft(inv_path) ~= nil
    if has_inv_image then
        table.insert(foodassets, Asset("IMAGE", "images/inventoryimages/" .. data.name .. ".tex"))
        table.insert(foodassets, Asset("ATLAS", "images/inventoryimages/" .. data.name .. ".xml"))
    end
    ...
    local function fn()
        ...
        if has_inv_image then
            ...
            inst.components.inventoryitem.atlasname = inv_path
        else
