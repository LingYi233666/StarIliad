...
local function onbecamehuman(inst)
	...
	inst.components.locomotor:SetExternalSpeedMultiplier(inst, "blythe_speed_mod", 1)
end
--当人物死亡的时候
local function onbecameghost(inst)
	-- 变成鬼魂的时候移除速度修正
	inst.components.locomotor:RemoveExternalSpeedMultiplier(inst, "blythe_speed_mod")
end
